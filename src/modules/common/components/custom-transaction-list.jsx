...
const CustomTransctionList = () => {
  ...
  return (
    <>
      <div className="w-full h-[5rem] grid grid-cols-2 border border-purple-800 shadow-md px-2">
      ...
      <div className="w-full max-h-full h-[80%] overflow-y-auto px-2">
        <div className="w-full h-[3rem] border bg-purple-800 border-purple-800 font-bold grid text-white grid-cols-7">
