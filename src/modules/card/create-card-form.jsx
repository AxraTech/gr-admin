...
const CreateCard = () => {
  ...
  return (
    <div className=" mt-8 w-full h-full relative p-5 flex flex-col items-center justify-center overflow-y-auto">
      <Toaster />
      <div className="min-w-[20rem] border border-gray-500 p-8 flex flex-col gap-12 rounded">
        <div>
        ...
        <div className="w-full">
          ...
          >
            ...
            <div className="h-12 w-full flex flow-row gap-4 items-center justify-between">
              <button
                type="submit"
                className="bg-gray-200 flex flex-row items-center justify-center transition min-w-28 duration-500 border-purple-900 text-white from-blue-900 to-gray-600 rounded font-light bg-gradient-to-l"
              >
              ...
              <button
                ...
                className=" bg-gray-200 transition min-w-28 duration-500 border-purple-900 text-white from-blue-900 to-gray-600 rounded font-light bg-gradient-to-l"
              >
                Back
              </button>
            </div>
